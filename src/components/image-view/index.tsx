...
export default function ImageView({src, className, alt, view}: ImageViewProps) {
    ...
    return (
        <>
            ...
            <Modal className={'bg-black'} hideCloseButton isOpen={isOpen} onOpenChange={onOpenChange} onClose={onClose}
                   size={'5xl'}>
                <ModalContent>
