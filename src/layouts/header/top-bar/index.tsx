							...
							{[
								{
									...
									icon: faInstagram,
									hoverColor:
										"dark:hover:text-[#E1306C] hover:text-[#E1306C]",
								},
								{
								...
								},
								{
									...
									icon: faFacebook,
									hoverColor:
										"dark:hover:text-[#1877F2] hover:text-[#1877F2]",
								},
								{
								...
								},
								{
									...
									icon: Youtube,
									hoverColor:
										"dark:hover:text-[#FF0000] hover:text-[#FF0000]",
								},
								{
									href: "https://t.me/imamzainorg",
									icon: faTelegram,
									hoverColor:
										"dark:hover:text-[#0088cc] hover:text-[#0088cc]",
								},
							].map((social, index) => (
								<Link
									key={index}
