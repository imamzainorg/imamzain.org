...
export default function DropdownLang() {
    ...
    return (
        <div className="relative cursor-pointer py-2 dropdown-lang">
            <button
            ...
            {isOpen && (
                <div className="absolute bg-white rounded-lg w-fit z-50 flex flex-col   py-1 px-4 text-gray-800 shadow-xl translate-y-2 animate-dropdown transition-all duration-300">
                    {languages.map((language, index) => (
                        ...
                        >
                           <p
                           className={' py-1 font-semibold text-gray-500  w-full h-full rounded px-2  cursor-pointer hover:text-white hover:bg-black  '}
                           >
                               {language.name}
                           </p>
                        </div>
