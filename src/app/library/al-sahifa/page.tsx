...
export default function RisalatAlHuquqPage() {
    ...
    <div>
      ...
      <div className="relative mt-4 md:mt-16 mb-8 mx-auto flex justify-start gap-20 p-8 md:p-10 backdrop-blur-[1px] shadow-lg shadow-primary/10 dark:shadow-Muharram_primary/10 dark:border-Muharram_primary rounded-[60px] border border-primary">
        <div className="w-full md:w-3/4 flex flex-col justify-around gap-5 md:pr-10">
          <h1 className="text-title font-semibold">الصحيفة السجادية الكاملة</h1>
          ...
          <div className="flex flex-row p-2">
            <Link
              ...
              className="w-full xs:w-fit text-note py-2 px-4 m-2 border-2 rounded-xl border-primary dark:border-Muharram_primary flex items-center gap-4 group"
            >
            ...
            <Link
              ...
              className="
    w-full xs:w-fit text-note py-2 px-4 m-2 
  ...
  "
      ...
      <div className="my-16">
        <h2 className="text-body font-semibold my-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:mx-32">
          {dataCard.map((card) => (
            ...
            >
              <h2 className="font-medium text-note">{card.title}</h2>
              <div className="text-xs lg:text-lg">{card.description}</div>
            </Link>
          ))}
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
            <div className="w-full md:w-1/2 relative">
              <input
                ...
                className="pr-12 w-full md:w-11/12 text-note bg-white rounded-xl border border-primary dark:border-Muharram_primary focus:ring-1"
                value={searchTerm}
            ...
            <div className="w-full md:w-1/5">
              <Button
                variant="outline"
                className="w-full !text-note bg-white md:p-5"
                onClick={() => {
                  setSearchTerm("");
                }}
              >
