		...
		<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-12 pt-8 border-t-2 border-gray-100 dark:border-zinc-700">
			{prevSubject ? (
				<Link
					...
					className="group relative overflow-hidden flex items-center gap-4 p-5 rounded-2xl bg-gradient-to-br from-white to-gray-50 dark:from-zinc-800 dark:to-zinc-900 border-2 border-gray-100 dark:border-zinc-700 hover:border-primary dark:hover:border-Muharram_primary hover:shadow-lg transition-all"
				>
					<div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-transparent dark:from-Muharram_primary/5 opacity-0 group-hover:opacity-100 transition-opacity" />
