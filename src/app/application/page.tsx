...
export const metadata: Metadata = {
	...
	description:
		"تطبيق أنوار سجادية للجوال: موسوعة متكاملة عن الإمام زين العابدين (ع) تضم الصحيفة السجادية ورسالة الحقوق والمسند والزيارات. حمّله من App Store وGoogle Play.",
	keywords: [
		"تطبيق أنوار سجادية",
		"تحميل تطبيق أنوار سجادية",
		"موسوعة الإمام زين العابدين",
		"تطبيق الصحيفة السجادية",
		"رسالة الحقوق",
		"مسند الإمام زين العابدين",
		"زيارات الإمام السجاد",
		"تطبيق الإمام السجاد للجوال",
	],
	alternates: { canonical: "/application" },
	openGraph: {
		title: "تطبيق أنوار سجادية – الموسوعة المتكاملة عن الإمام زين العابدين (ع)",
		description:
			"تطبيق جوال يجمع الصحيفة السجادية كاملة محرّكة ومقابَلة على عدة نسخ، ورسالة الحقوق، ومسند الإمام، وزياراته، وسيرته العطرة، مع التقويم الهجري وحكمة اليوم. متوفر على App Store وGoogle Play.",
		url: "/application",
		type: "website",
		images: ["/application/main-bg.jpg"],
	},
	twitter: {
		card: "summary_large_image",
		title: "تطبيق أنوار سجادية – الموسوعة المتكاملة عن الإمام السجاد",
		description:
			"موسوعة متكاملة عن الإمام زين العابدين (ع) تضم الصحيفة السجادية ورسالة الحقوق والمسند والزيارات. متوفر على App Store وGoogle Play.",
		images: ["/application/main-bg.jpg"],
	},
}
				...
				<div className="container flex flex-col justify-between py-10 lg:py-20 w-full h-full ">
					<div className="flex flex-col justify-center gap-2 lg:gap-6 bg-neutral-100  self-start z-20 w-[15rem] lg:w-[30rem] p-5 lg:p-10 rounded-xl xl:mr-32">
						...
						<p className="text-sm lg:text-xl">
							كل الزيارات المخصوصة والمطلقة التي يزار بها الإمام
	...
	return (
		<div className="container pt-20">
			<div className="flex flex-col items-center justify-center gap-3 pb-10 text-center">
				...
				<p className="text-xl">
					يقدم تطبيق أنوار سجادية ميزات مخصصة تشمل الوصول السريع،
					البحث المتقدم، وتجربة استخدام معززة لتفاعلك الروحي
				</p>
			</div>
