        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <GradientCard className="p-6 lg:p-8">
              ...
              <div className="space-y-4">
                <RuleItem>
                  تُقدم المسابقة جوائز لـ 50 فائزاً؛ حيث يحصل الثلاثة الأوائل
                  على أجهزة تاب، بينما يُمنح السبعة الآخرين من العشرة الأوائل
                  جوائز عينية وتبركية، وُيخصص لـ 40 فائزاً آخرين شرف زيارة
                  الإمام الحسين (عليه السلام) والتبرك بمضيفه الطاهر
                </RuleItem>
