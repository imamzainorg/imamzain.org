  ...
  const contestData = [
    {
      id: 1,
      title:
        "مسابقة الإمام زين العابدين (عليه السلام) الدولية الاولى في الخط العربي",
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="relative py-16 md:py-24">
          <div className="text-center">
            ...
            >
              مسابقات في تراث
              <span className="block text-primary">الإمام زين العابدين</span>
            ...
            >
              نفتح أبواب المشاركة لكل من يسعى لنشر المعرفة، إحياء التراث،
              والتعبير عن الولاء عبر مسابقات فكرية، بحثية، وفنية متميزة.
            </motion.p>
          </div>
        </section>
        ...
        <section className="py-8">
          <div className="text-center mb-12">
            ...
            <motion.p
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.1 }}
              className="text-subtitle text-slate-600 max-w-2xl mx-auto"
            >
              اكتشف المسابقات المتاحة حالياً وشارك في إثراء التراث الإسلامي
            </motion.p>
          </div>
            ...
            {contestData.map((contest, index) => (
              ...
              >
                <div className="bg-white rounded-3xl shadow-lg border border-slate-200 overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4 z-20">
                      <span className="inline-flex items-center gap-1 bg-green-500/20 backdrop-blur-sm rounded-full px-3 py-1 text-sm font-medium text-white">
                        ...
                        {contest.status === "active" ? "نشط" : "غير نشط"}
                      </span>
                    </div>
                  </div>
                  ...
                  {/* Contest Content */}
                  <div className="p-6">
                    <h3 className="text-note leading-7 font-bold text-slate-800 mb-2">
                      {contest.title}
                    </h3>
                    <p className="text-subtitle text-primary font-medium mb-3">
                      {contest.subtitle}
                    </p>
                    <p className="text-slate-600  text-subtitle mb-6 line-clamp-3">
                      {contest.description}
                    </p>

                    {/* Contest Details */}
                    <div className="grid grid-cols-2 gap-4 text-subtitle		 mb-6">
                      ...
                      <div className="flex items-center gap-2  text-slate-600">
                        ...
                        <span>{contest.participants} من المشاركين</span>
                      </div>
                      <div className="flex items-center gap-2  text-slate-600">
                    ...
                    <Link href={contest.link}>
                      <button className="w-full bg-gradient-to-r text-subtitle	 from-primary to-secondary dark:from-Muharram_primary dark:to-Muharram_secondary text-white rounded-xl py-3 px-6 font-medium transition-all duration-300 hover:shadow-lg hover:shadow-primary/25 flex items-center justify-center gap-2 group">
                        تفاصيل المسابقة
        ...
        <section className="py-16">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              انضم إلى مجتمع الباحثين والمبدعين في التراث الإسلامي وشارك في
              إثراء المعرفة
            </p>
