...
export default function VideoComponent() {
    ...
    return (
        ...
        >
            ...
            <div
                className="absolute group top-0 right-0 w-full  font-semibold text-sm h-full pointer-events-none z-20  "

            >
                <div
                    className="container flex flex-col justify-end items-start w-full h-full p-8 gap-4   cursor-pointer ">
