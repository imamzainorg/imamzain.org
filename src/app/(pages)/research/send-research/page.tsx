...
const StepSection = ({ step, title, children , Boarded }: StepSectionProps) => {
  return (
    <div className={`relative pr-16 pb-16 ${!!Boarded && 'border-r-secondary border-r-4' }`}>
      ...
      <div className="pt-20 pr-20  ">
        <StepSection step={1} title="الضوابط العامة" Boarded>
          <ul className="list-decimal space-y-2 ">
            ...
            <li>
              الابتعاد عن كل ما يثير التعصب الطائفي بين المذاهب أو الأديان.
            </li>
            <li>
        ...
        <StepSection step={2} title="المواصفات الفنية للبحث " Boarded>
          <div className="text-right text-gray-800 leading-relaxed  " >
            <div>
              <h2 className="font-bold text-2xl">تقسيم الأبحاث:</h2>
              <ul className="list-decimal pr-6 space-y-2">
                <li>
                  إذا كان حجم الكتاب أقل من 300 صفحة، يقسم إلى فصول ومباحث.
                </li>
                <li>
                  إذا كان أكثر من 300 صفحة:
                  <ul className="list-disc pr-6 mt-2 space-y-1">
                    <li>
                      لموضوع واحد: يقسم إلى أبواب، كل باب فيه فصول ومباحث.
                    </li>
                    <li>
                      لموضوعات متعددة: يقسم إلى أقسام، كل قسم فيه أبواب وفصول.
                    </li>
                  </ul>
                </li>
            ...
            <div>
              <h2 className="font-bold text-2xl">مواصفات الصفحة:</h2>
              <ol className="list-decimal list-inside space-y-3 text-right">
                ...
                <li>
                  ...
                  <ul className="list-disc list-inside pr-5 mt-2 space-y-2">
                    ...
                    <li>
                      حجم خط الهوامش: <strong>12</strong>، وتوضع أسفل كل صفحة
                    </li>
                    <li>
                      المسافة بين الأسطر: <strong>1.15</strong>
                    </li>
                    <li>
                      أن تكون الهوامش <strong>2 سم</strong> من جميع الجهات
                    </li>
                  </ul>
                </li>
                <li>
                  لا تحتسب الصفحات الفارغة وصفحات العناوين والفهارس في العدد
                  الإجمالي.
                </li>
              </ol>
            </div>
            ...
            <div>
              ...
              <ul className="list-decimal pr-6 space-y-2">
                ...
                <li>
                  من كتب المفكرين: توضع بين قوسين صغيرين أو اعتياديين حسب
                  الحالة.
                </li>
                <li>من الإنترنت: يُذكر الرابط الكامل وتاريخ النسخ.</li>
              </ul>
            </div>
          </div>
        </StepSection>

        <StepSection step={3} title="شروط النشر والملكية الفكرية" Boarded>
          <ol className="list-decimal list-inside space-y-3 text-right">
            <li>
              البحوث والكتب المقدمة عبر <strong>الاستكتاب</strong> تخضع للشروط
              السابقة.
            </li>
            <li>
            ...
            <li>
              يلزم تقديم ملخص للبحث باللغة العربية (150-200 كلمة) يشمل:
              <ul className="list-disc list-inside pr-5 mt-2 space-y-2">
                <li>أهداف البحث</li>
            ...
            <li>
              <strong>حقوق النشر</strong>: تصبح ملكًا للمؤسسة بعد القبول، ولا
              يجوز إعادة النشر دون موافقة خطية.
            </li>
            <li>
              <strong>نسبة الاقتباس</strong>: ألا تزيد عن <strong>10%</strong>{" "}
              (باستثناء المقدمة والهوامش).
            </li>
            <li>
              <strong>التحكيم</strong>: تُحكَّم البحوث من قِبَل خبيرين متخصصين،
              ويجب ألا تكون منشورة سابقًا.
            </li>
            <li>
              <strong>إعادة الطباعة</strong>: تحتاج إلى إذن كتابي من صاحب حقوق
              النشر.
            </li>
            <li>
              <strong>الإخطار بالقرار</strong>: تُبلغ المؤسسة الباحث بقرارها
              خلال <strong>شهرين</strong> من تقديم البحث.
            </li>
            <li>
              <strong>السرية والأمانة العلمية</strong>: تلتزم المؤسسة باحترام
              خصوصية البحث.
            </li>
            <li>
              <strong>لا تُعاد</strong> البحوث غير المقبولة إلى الباحثين.
            </li>
          </ol>
        </StepSection>
        ...
        <StepSection step={5} title="أرسال البحث مع إقرار الباحث" >
            <div>
                <p>رفع البحث مع اقرار الباحث على جهات التواصل التالية </p>
                <p>البريد الإلكتروني: info@imamzain.org</p>
                <p>رقم الهاتف: 0780 794 3999</p>
            </div>
        </StepSection>
      </div>
    </div>
