        ...
        <div className={'bg-[#FDD79C] '}>
            <div className="relative top-0 h-[40rem] lg:h-[70rem] w-full mx-auto xl:w-[100rem]">
                ...
                <div className="container flex flex-col justify-between   py-10 lg:py-20 w-full h-full ">
                    ...
                    <div
                        className="flex flex-col justify-center gap-2 lg:gap-6 bg-neutral-100  self-start z-20 w-[15rem] lg:w-[30rem] p-5 lg:p-10 rounded-xl xl:mr-32  ">
                        <h2 className="text-sm lg:text-2xl font-bold">
                            زيارات الإمام زين العابدين(عليه السلام)
                        </h2>
                        <p className="text-sm lg:text-xl">
                            كل الزيارات المخصوصة والمطلقة التي يزار بها الإمام زين العابدين(عليه السلام)
                        </p>
                    </div>


                    <div
                        className=" flex flex-col justify-center gap-2 lg:gap-6 bg-neutral-100 self-end z-20  w-[15rem] lg:w-[30rem] p-5 lg:p-10 rounded-xl xl:ml-32 ">
                            <h2 className="text-sm lg:text-2xl font-bold">
                                زيارات الإمام زين العابدين(عليه السلام)
                            </h2>
                            <p className="text-sm lg:text-xl">
    ...
    return (
        <div className="container pt-20">
            <div className="flex flex-col items-center justify-center gap-3 pb-10 text-center">
                ...
                <p className="text-xl">
                    يقدم تطبيق أنوار سجادية ميزات مخصصة تشمل الوصول السريع، البحث
                    المتقدم، وتجربة استخدام معززة لتفاعلك الروحي
                </p>
            </div>
                    ...
                    <>
                        <div
                            ...
                            <div className="flex flex-col justify-between items-center gap-4 text-center">
                                ...
                                <p className="text- text-neutral-500 leading-6">{feature.description}</p>
                            </div>
                        </div>
                    </>
                ))}
