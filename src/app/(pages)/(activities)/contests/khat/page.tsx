...
<ButtonLink
        href="/contests/khat/president-goals/#president-message" label="		كلمة رئيس المؤسسة" className="border-secondary border-2"/>
                    <ButtonLink
        href="/contests/khat/president-goals/#goals" label="أهداف المسابقة" className="border-secondary border-2"/>
