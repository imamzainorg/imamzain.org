			...
			<div className="my-6 sm:my-8 lg:my-10 ">
				...
				<div className="mt-6 p-6">
					<div className="prose prose-lg max-w-none text-justify leading-relaxed">
						...
						<p
							className="flex flex-col  justify-start font-semibold"
							dir="ltr"
						>
							<span className="text-md md:text-lg text-center md:text-left">
								رئيس مؤسسة الإمام زين العابدين{" "}
								<span className="flex flex-col md:flex-row md:ml-16 text-center">
									( عليه السلام)
								</span>
							</span>
							<span className="text-md md:text-lg   text-center md:text-left ">
								{" "}
								السيد غسان الخرسان ( دام توفيقه)
							</span>
						</p>
					</div>
				</div>
					...
					<div className="prose prose-lg max-w-none text-right">
						<ol className=" arabic-list mr-6 space-y-4">
							...
							<li>
								...
								السلام) الزاخر من الصحيفة السجادية ورسالة الحقوق
