...
const Slide = ({ slide, index, current, handleSlideClick }: SlideProps) => {
	...
	const { src, button, link, title } = slide
	...
	return (
		<div className="[perspective:1200px] [transform-style:preserve-3d]">
			...
			>
				<div
					className="absolute top-0 left-0 w-full h-full bg-[#e5e5d4] rounded-[1%] overflow-hidden transition-all duration-150 ease-out"
					style={{
						transform:
							current === index
