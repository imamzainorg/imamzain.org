	...
	return (
		<>
			<Head>
				...
				/>
				<title>
					ملتقى البقيع الثاني - مؤسسة الإمام زين العابدين للبحوث
					والدراسات
				</title>
			</Head>
			<div className="bg-gray-100 text-gray-800 font-serif">
				...
				>
					...
					<p className="text-xl md:text-2xl max-w-2xl mb-3">
						تحت شعار &ldquo;البقيع: تراث إسلامي وذاكرة الأمة&ldquo;
					</p>
						...
						<div className="flex flex-col md:flex-row items-center">
							<div className="md:flex-1 md:pr-5">
								<p className="mb-5 text-lg">
									نظرًا لأهمية التراث الإسلامي عموماً، وما
									يحمله البقيع من رمزية دينية وتاريخية، وفي
									إطار الجهود الرامية إلى التعريف بالبعد
									الفكري العقائدي والثقافي التاريخي لهذا
									المعلم الإسلامي المقدس، والذي يمثل مصداقا
									واضحاً للتعدي على المكانة السامية لأئمة أهل
									البيت، ويقدم أنموذجا للتعصب العقائدي والتطرف
									الفكري الذي ما زال المسلمون -قبل غيرهم-
									يتجرعون منه مرارة العيش وغياب الأمن والأمان،
									ومحاولةً لتمرير المباني الفقهية الخاصة
									وطرحها في الواقع العملي على أنها مسلمات
									دينية وتاريخية؛ للتأثير على وجدان الأمة
									عموماً.
								</p>
								<p className="text-lg">
									من هنا تسعى مؤسسة الإمام زين العابدين للبحوث
									والدراسات الى تركيز الضوء على أهم المفاصل
									العلمية والثقافية في هذا الحدث المهم في
									الملتقى الثاني الذي تروم عقده بمناسبة هدم
									تلك القبور الطواهر في الثامن من شهر شوال.
								</p>
							</div>
				...
				<section id="objectives" className="py-16 bg-gray-50">
					<div className="max-w-7xl mx-auto px-5">
						...
						<ul className="list-disc list-inside space-y-4 text-lg pr-5">
							<li>
								تحليل تداعيات هدم البقيع من منظور فكري عقائدي،
								وحضاري اجتماعي، وإبراز أثر ذلك على وعي المجتمع
								الإسلامي.
							</li>
							<li>
								إبراز الأهمية الدينية والتاريخية للبقيع بوصفه
								مدفنًا لأربعة من أئمة أهل البيت وجملة من الصحابة
								الكرام.
							</li>
							<li>
								مناقشة الرؤى الفقهية والفكرية المتعلقة بإحياء
								التراث الإسلامي، وطرح دراسات تحليلية حول مشروعية
								الحفاظ على المقدسات.
							</li>
							<li>
								إحياء الهوية الإسلامية عبر دراسة البقيع كنموذج
								يعكس جدلية العلاقة بين الدين والحضارة ودور
								المعالم الإسلامية في تشكيل الوعي الجمعي.
							</li>
						</ul>
						...
						<ul className="list-disc list-inside space-y-4 text-lg pr-5 mt-4">
							<li>
								تعزيز الوعي بأهمية المواقع الإسلامية التاريخية،
								وفتح آفاق لحوار العلمي حول دورها في حفظ الهوية
								الإسلامية.
							</li>
							<li>
								تقديم قراءات تحليلية جديدة تربط بين الماضي
								والحاضر، وتحث على تبني استراتيجيات تحفظ التراث
								الإسلامي من الاندثار أو التغييب.
							</li>
							<li>
								مناقشة القضايا المرتبطة بالبقيع ضمن إطار علمي
								رصين، يسهم في إثراء الفكر الإسلامي وتعزيز
								الاهتمام بالمقدسات الدينية كجزء من الهوية
								الحضارية للأمة.
							</li>
						</ul>
					</div>
				...
				<section id="schedule" className="py-16 bg-gray-50">
					<div className="max-w-3xl mx-auto px-5">
						...
						<div className="text-center mb-8">
							<h3 className="text-2xl text-[#1a3c40] mb-4">
								الجلسة الأولى
							</h3>
						...
						<div className="space-y-4">
							{[
								...
								>
									...
									<div className="flex-1 p-4">
										<h3 className="text-xl text-[#1a3c40]">
											{item.title}
										</h3>
									</div>
								</div>
							...
							<div className="mt-10 text-center">
								...
								<p className="text-gray-600 mb-6">
									انطلاق فعاليات الجلسة الثانية الساعة 1:30
									بعد الظهر
								</p>
							</div>
							{[
								...
								{
									time: "2:45 - 2:50",
									title: "تكريم الجامعات",
								},
								{
									time: "2:50 - 3:30",
									title: "تكريم الباحثين المشاركين في المؤتمر العلمي الأول جماعياً",
								},
							].map((item, index) => (
								<div
									key={index}
							...
							<p className="text-center text-gray-600 mt-6">
								ختام الملتقى الساعة 3:30 عصراً، وهو موعد انطلاق
								السيارات التي تقل ضيوف المحافظات البعيدة الى
								مكان استراحتهم في كربلاء المقدسة
							</p>
						</div>
					</div>
				</section>
				...
				<footer className="bg-[#1a3c40] text-white py-12">
					<div className="max-w-7xl mx-auto px-5">
						...
						<div className="text-center border-t border-[#2a5559] pt-4">
							&copy; {new Date().getFullYear()} مؤسسة الإمام زين
							العابدين للبحوث والدراسات. جميع الحقوق محفوظة.
						</div>
					</div>
				</footer>
			</div>
