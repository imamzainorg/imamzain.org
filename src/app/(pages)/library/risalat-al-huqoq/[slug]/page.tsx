	...
	<div className="space-y-10 my-8">
	  <Breadcrumbs
		links={[
		  ...
		  { name: "رسالة الحقوق", url: "/library/risalat-al-huquq" },
		  { name: book.title, url: "#" },
		]}
	  />
	  ...
	  <div className="space-y-10 my-8">
		...
		<div className="bg-secondary dark:bg-Muharram_secondary/10 bg-opacity-10 rounded-xl grid grid-cols-1 lg:grid-cols-2 p-2 lg:px-8">
