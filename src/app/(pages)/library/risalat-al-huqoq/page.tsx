	...
	return (
		<div className="">
			...
			<div className="relative mt-4 md:mt-16 mb-8 mx-auto flex justify-start gap-20 p-8 md:p-10 backdrop-blur-[1px] shadow-lg shadow-primary/10 dark:shadow-Muharram_primary/10 rounded-[60px] border border-primary dark:border-Muharram_primary ">
				...
				<div className="w-80 max-md:hidden left-20 -top-20 relative">
					<Image
						src={`/shapes/book-bg_Muharram.svg`}
						className="w-full"
						width={50}
					...
					/>
					<Image
						src={`/images/risalat-al-huqoq.jpg`}
						className="absolute w-2/3 -top-5 left-0 right-0 bottom-0 m-auto rounded-xl"
						width={400}
						height={400}
						alt="رسالة الحقوق"
					/>
...
>>>>>>> 301e0785c7ddd4c72cb75caab7b91ed0f42252fd
