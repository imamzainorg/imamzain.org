...
export default function Alsahifa() {
  return (
    <div className="">
      <div className="m-10">
        <Breadcrumbs
        ...
        />
        <div className="flex flex-col md:flex-row mx-auto justify-start items-center gap-4 my-8">
          <div className="w-52 h-10 md:h-28 bg-[url('/shapes/button-bg.svg')] bg-contain bg-center bg-no-repeat flex justify-center items-center  text-white">
            الصحيفة كاملة
          </div>
