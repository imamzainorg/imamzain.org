		...
		>
			...
			>
				...
				<div className="flex-1">
					{/* key={videoId} يجبر إعادة تركيب الـ iframe بالكامل لما تتغير
					    الحلقة المختارة من قائمة التشغيل — بدونها ما كان الفيديو
					    الجديد يضمن التحميل، وكل الحلقات كانت تودي لنفس الفيديو
					    المفتوح أول مرة */}
					<iframe
						key={videoId}
