...
const BREAKPOINTS = [
	{ key: "xs", peaks: 50, show: "block sm:hidden" },
	{ key: "sm", peaks: 50, show: "hidden sm:block md:hidden" },
	{ key: "md", peaks: 200, show: "hidden md:block lg:hidden" },
	{ key: "lg", peaks: 250, show: "hidden lg:block xl:hidden" },
	{ key: "xl", peaks: 300, show: "hidden xl:block" },
] as const
...
export function useWaveform(items: AudioItem[]) {
	const canvasRefs = useRef<
		Record<number, Record<BreakpointKey, HTMLCanvasElement | null>>
	>({})
