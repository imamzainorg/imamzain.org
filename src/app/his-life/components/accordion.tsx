			...
			<AccordionItem
				...
				title={
					<div className=" relative bg-primary dark:bg-Muharram_primary p-4 text-white shadow-lg rounded-2xl font-bold overflow-hidden z-10">
						<span className="mr-8 text-subtitle">{section.title}</span>
			...
			>
				...
				<div className="w-full flex justify-end ">
					<Link
						...
						className=" text-primary text-subtitle dark:text-Muharram_primary p-4  flex items-center gap-4 group -translate-y-10"
					>
						قراءة المزيد
