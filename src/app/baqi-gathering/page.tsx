...
const Hero = () => (
	<section
		className="relative h-[60vh] flex flex-col justify-end pb-12 items-center text-center text-white px-5"
		style={{
			background:
	...
	>
		...
		<p className="text-xl md:text-2xl max-w-3xl mb-3">الهوية والتاريخ</p>
...
const SpeakersSection = () => {
	const speakers = [
		...
		},
		{
			...
			name: "سماحة الشيخ محمد آل حيدر",
			title: "هدم قبور البقيع.. المناشىء الفكرية والتداعيات الاجتماعية",
		},
	]
	return (
...
const ScheduleSection = () => {
	const scheduleItems = [
		...
		},
		{
			...
			lectures: [
				{ title: "المحاضرة الأولى: سماحة الشيخ محمد آل حيدر دام عزه" },
				{
					title: "المحاضرة الثانية: الأستاذ الدكتور حسن الحكيم المحترم",
				},
				{ title: "المحاضرة الثالثة: سماحة الشيخ ستار الجيزاني" },
			],
		...
		<section id="schedule" className="py-16 bg-gray-50">
			<div className="container">
				...
				<p className="text-center text-gray-600 pt-6 text-xl">
					ختام الملتقى الساعة 3:30 عصراً، وهو موعد انطلاق السيارات
					التي تقل ضيوف المحافظات البعيدة إلى مكان استراحتهم في كربلاء
					المقدسة
				</p>
			</div>
		</section>
