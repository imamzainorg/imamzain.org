        ...
        <section id="schedule" className="py-16 bg-gray-50">
            <div className="container">
                ...
                <div className="flex justify-center mb-8">
                    <div
                        className="px-8 py-3 bg-gray-300 text-lg font-medium rounded hover:bg-gray-400 transition-all duration-300">
                        يوم الجمعة - 12 شوال
                    </div>
                </div>
                    ...
                    {scheduleItems.map((item, index) => (
                        ...
                        >
                            <div className="flex flex-col md:flex-row">
                                <div
                                    className="bg-[#0B1F47] text-white flex flex-col justify-center items-center p-4 md:w-40">
                                    <span>{item.time}</span>
                                    {item.duration && (
