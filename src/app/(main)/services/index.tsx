          ...
          <div className="relative text-white flex flex-col items-center  space-y-2">
            ...
            <div className="container  flex flex-col items-center py-12  ">
              ...
              <div className="flex justify-between flex-col lg:flex-row items-center gap-4">
                ...
                <div
                    className="w-1/2 w-[300px] h-[300px] md:w-[520px] md:h-[500px] xl:w-[800px] xl:h-[600px] flex md:flex-col items-center justify-center bg-[url('/shapes/ziara-bg.svg')] bg-center bg-no-repeat"
                >
                  <ZiaraForm />
                </div>
              </div>
