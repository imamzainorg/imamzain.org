	...
	return (
		<>
			<div className="container flex flex-col gap-12 py-32">
				...
				<div
					className="grid
             grid-cols-1 sm:grid-cols-2 md:grid-cols-2  lg:grid-cols-5  xl:grid-cols-5
             auto-rows-[15rem] sm:auto-rows-[15rem] md:auto-rows-[17rem]  lg:auto-rows-[12rem]  xl:auto-rows-[13rem]
             gap-4
