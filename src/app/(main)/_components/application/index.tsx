            ...
            <div
               ...
               shadow-[0px_0px_2.7px_-10px_rgba(0,0,0,0.034),0px_0px_6.9px_-10px_rgba(0,0,0,0.049),0px_0px_14.2px_-10px_rgba(0,0,0,0.061),0px_0px_29.2px_-10px_rgba(0,0,0,0.076),0px_0px_80px_-10px_rgba(0,0,0,0.11)]
                ...
                <motion.div
                    ...
                    initial="hidden"
                    animate="visible"
                    className="w-full  h-inherit lg:w-1/2 flex flex-col gap-4 lg:gap-8 xl:gap-14 max-lg:text-center"
                >
                ...
                <Link href={"/application"}
                      className="relative flex justify-center items-center ml-10 w-[20rem] h-[24rem]">
                    <motion.div
