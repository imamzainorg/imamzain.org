					...
					<div className="flex flex-col lg:flex-row items-center gap-10">
						<div className="lg:w-1/2 text-right  space-y-6">
							...
							<h2 className="text-title xl:leading-normal font-bold text-gray-900">
								مسابقة الإمام زين العابدين (عليه السلام) الدولية الأولى
								في الخط العربي
							</h2>
						...
						<div className="xs:w-2/4 sm:w-1/4 mx-auto relative">
							...
							{/* Prize Awards */}
							<div className="absolute  -top-8 lg:-top-12 xl:-left-4 2xl:left-24 -left-16 md:-left-10  flex items-end gap-4">
								{/* 3rd Place - Left */}
