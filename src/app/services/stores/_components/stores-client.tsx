...
export default function StoresClient({
  ...
  return (
    <div className="mx-auto md:container pb-10 scroll-smooth ">
      ...
      <h1 className="text-title	font-bold text-gray-900 my-10 text-center">
        نقاط البيع المباشر
      </h1>
            ...
            <nav className="flex flex-col gap-2 text-subtitle">
              {storeLocations.map((cityBlock) => (
                <div key={cityBlock.city}>
                  <h3 className="text-subtitle text-gray-500 font-semibold mb-1 mt-2 px-1">
                    {cityBlock.city}
                  </h3>
                  ...
                  >
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="flex-1">
                        <h4 className="text-note font-semibold text-gray-800 mb-2 ">
                          {sellpoint.name}
                        </h4>
                        ...
                        <div className="flex text-subtitle	 flex-col md:flex-row items-start md:items-center gap-2 mt-4">
                          <Button
                            onClick={() => {
                          ...
                          >
                            <NewsShare
                              ...
                              iconSize={20}
                            />
                            <p className="text-subtitle "> مشاركة</p>{" "}
                          </Button>

                          <Button
                            asChild
                            className="mt-4 text-subtitle inline-flex items-center gap-2 bg-primary border border-primary dark:bg-Muharram_primary dark:border-Muharram_primary text-white transition-all font-medium px-2.5 py-1.5 rounded-xl shadow-sm cursor-pointer hover:scale-105"
                          >
                            <Link
                              className="text-subtitle"
