				...
				<div className=" w-full p-2 border-2 border-secondary dark:border-Muharram_secondary drop-shadow-lg rounded-2xl flex flex-col justify-start items-center gap-8 text-center">
					<div className="w-full rounded-2xl flex flex-col  justify-between items-center gap-4 text-center p-8 bg-white border-[0.1px] border-nuetral-200">
						...
						<p className="text-2xl   text-neutral-500 md:leading-10">
							السلام عليك يا زين العابدين ، السلام عليك يا زين
							المتهجدين ، السلام عليك يا إمام المتقين ، السلام
							عليك يا درة الصالحين ، السلام عليك يا ولي المسلمين ،
							السلام عليك يا قرة عين الناظرين العارفين ، السلام
							عليك يا خلف السابقين ، السلام عليك يا وصي الوصيين ،
							السلام عليك يا خازن وصايا المرسلين ، السلام عليك يا
							ضوء المستوحشين ، السلام عليك يا نور المجتهدين ،
							السلام عليك يا سراج المرتاضين ، السلام عليك يا ذخر
