...
export default function UploadedResearchPage() {
  ...
  const { currentResearch, totalPages } = useMemo(() => {
    ...
    return {
      currentResearch: filteredResearch.slice(start, start + itemsPerPage),
                ...
                <div className="p-6 flex flex-col h-full">
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      <span className="px-3 py-1 bg-primary/10 dark:bg-Muharram_primary/20 text-primary dark:text-Muharram_primary rounded-full text-subtitle leading-4 lg:leading-6 font-medium">
                        {item.conference}
                      </span>
                    </div>
