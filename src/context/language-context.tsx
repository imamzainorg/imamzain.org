...
const LanguagesContext = createContext<LanguagesContextProps | undefined>(undefined);
...
export const LanguagesProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    return (
        <LanguagesContext.Provider value={{ currentLanguage, setLanguage, languages }}>
            {children}
