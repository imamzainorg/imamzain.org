...
export const libraryBooks: Book[] = [
  {
    ...
    views: Math.floor(Math.random() * 100),
    image:
      "/library/أساليب الإصلاحات الإجتماعية عند الإمام السجّاد (ع) - السيد محسن الجلالي.jpg",
  ...
  },
  {
    ...
    views: Math.floor(Math.random() * 100),
    image:
      "/library/الفرائد الطريفة في شرح الصحيفة الشريفة (تحقيق السيد مهدي الرجائي).jpg",
  ...
  },
  {
    ...
    views: Math.floor(Math.random() * 100),
    image:
      "/library/الموسوعة السجادية  - الصحيفة السجادية الدراسة السندية الببليوغرافيا النص ج3.jpg",
